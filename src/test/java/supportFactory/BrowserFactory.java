...
class BrowserFactory {
	...
	private static final Browser browser = Browser.valueOf(TestRunner.config.get("browser"));
	
	private static final String desiredBrowserVersion = TestRunner.config.get("browserVersion");
